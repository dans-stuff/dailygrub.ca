...
export default function Home() {
  // Only active cities get tiles (deals present AND >=5% estimated coverage,
  // see build-deals.mjs); empty provinces drop out with them.
  const cities = getCities().filter((c) => c.active);
